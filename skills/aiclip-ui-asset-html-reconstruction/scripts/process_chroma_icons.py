#!/usr/bin/env python3
# Derived from AiClip by shouzi23333-rgb (https://github.com/shouzi23333-rgb/AiClip)
# Original project license: CC-BY-NC-4.0. Preserve attribution; non-commercial use only unless relicensed.
